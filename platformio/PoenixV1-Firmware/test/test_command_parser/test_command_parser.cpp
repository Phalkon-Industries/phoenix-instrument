...
void assert_no_overrides(const phoenix_benchmark::parser::CommandArguments& arguments) {
...
static void test_parse_command_accepts_plain_command(void) {
  const phoenix_benchmark::parser::ParseOutcome outcome =
      phoenix_benchmark::parser::parse_command("channel_map", k_expected_command);
...
static void test_parse_command_supports_key_value_overrides(void) {
  ...
  const phoenix_benchmark::parser::ParseOutcome outcome =
      phoenix_benchmark::parser::parse_command(line, k_expected_command);
...
static void test_parse_command_rejects_json_with_unknown_arguments(void) {
  ...
  TEST_ASSERT_EQUAL_STRING(phoenix_benchmark::parser::k_error_unknown_argument, outcome.error_message);
}
...
static void test_parse_command_rejects_json_with_missing_arguments(void) {
  ...
  TEST_ASSERT_NOT_NULL(outcome.error_message);
  TEST_ASSERT_EQUAL_STRING(phoenix_benchmark::parser::k_error_missing_argument, outcome.error_message);
}
...
static void test_parse_command_rejects_json_with_invalid_value_types(void) {
  ...
  TEST_ASSERT_NOT_NULL(outcome.error_message);
  TEST_ASSERT_EQUAL_STRING(phoenix_benchmark::parser::k_error_invalid_value, outcome.error_message);
}

static void test_parse_command_rejects_unknown_arguments(void) {
  const phoenix_benchmark::parser::ParseOutcome outcome =
      phoenix_benchmark::parser::parse_command("channel_map unsupported=1", k_expected_command);
...
static void test_parse_command_rejects_malformed_key_value_token(void) {
  const phoenix_benchmark::parser::ParseOutcome outcome =
      phoenix_benchmark::parser::parse_command("channel_map sweeps=100 invalidtoken dwell_us=40", k_expected_command);
...
static void test_parse_command_rejects_key_value_with_invalid_value(void) {
  const phoenix_benchmark::parser::ParseOutcome outcome =
      phoenix_benchmark::parser::parse_command("channel_map sweeps=ten dwell_us=50 wiper=0x05", k_expected_command);
...
static void test_parse_command_rejects_empty_input(void) {
  const phoenix_benchmark::parser::ParseOutcome outcome =
      phoenix_benchmark::parser::parse_command("   \t\n", k_expected_command);

  TEST_ASSERT_FALSE_MESSAGE(outcome.success, "Whitespace-only input should be rejected");
  TEST_ASSERT_NOT_NULL(outcome.error_message);
  TEST_ASSERT_EQUAL_STRING(phoenix_benchmark::parser::k_error_invalid_command, outcome.error_message);
}

static void test_parse_command_rejects_null_input(void) {
  const phoenix_benchmark::parser::ParseOutcome outcome =
      phoenix_benchmark::parser::parse_command(nullptr, k_expected_command);
